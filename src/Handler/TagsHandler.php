...
use Mia\Finder\Repository\MiaFinderTagRepository;

/**
 * Description of ListHandler
 * 
 * @OA\Post(
 *     path="/mia-finder/tags",
 *     summary="MiaFinder Tags",
 *     tags={"MiaFinder"},
 *     @OA\RequestBody(
 ...
 */
class TagsHandler extends AbstractFinderHandler
{
    /**
     * 
    ...
    public function handle(\Psr\Http\Message\ServerRequestInterface $request): \Psr\Http\Message\ResponseInterface 
    {
        ...
        // Process Query
        $rows = MiaFinderTagRepository::fetchByConfigure($configure);
        // Return data
