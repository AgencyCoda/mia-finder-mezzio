...
use Mia\Finder\Model\MiaFinderPermission;

/**
 * Description of MiaFinderPermissionRepository
 *
 * @author matiascamiletti
 */
class MiaFinderPermissionRepository 
{
    /**
     * 
    ...
    {
        $query = MiaFinderPermission::select('mia_finder_permission.*');
